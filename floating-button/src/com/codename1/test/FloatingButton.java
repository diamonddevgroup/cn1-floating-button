...
public class FloatingButton extends Button {
    ...
    private void showFloatingCommands(Map<Command, Character> floatingCommands) {
        Container cmdCont = new Container(new BoxLayout(BoxLayout.Y_AXIS));
        for (Map.Entry<Command, Character> entry : floatingCommands.entrySet()) {
            ...
            cmdCont.add(FlowLayout.encloseRightBottom(bl.add(BorderLayout.CENTER, btn)));
        ...
        cmdCont.getStyle().setPaddingUnit(this.getStyle().getMarginUnit());
        cmdCont.getStyle().setPadding(0, 0, marginLeft, marginRight);
